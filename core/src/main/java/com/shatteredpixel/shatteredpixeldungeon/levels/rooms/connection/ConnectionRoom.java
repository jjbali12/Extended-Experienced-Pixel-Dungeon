...
import static com.shatteredpixel.shatteredpixeldungeon.Challenges.TOWER_OF_INF;
...
public abstract class ConnectionRoom extends Room {
	...
	private static float[][] chances = new float[107][];
	static {
		...
		chances[51] = chances[50] = chances[49] = chances[48] = chances[47] = chances[46];

		chances[52] = new float[]{4, 4,     4, 5,      4, 4};
		chances[57] = chances[56] = chances[55] = chances[54] = chances[53] = chances[52];

		chances[58] = new float[]{4, 4,     4, 5,      4, 4};
		chances[63] = chances[62] = chances[61] = chances[60] = chances[59] = chances[58];

		chances[64] = new float[]{4, 4,     4, 5,      4, 4};
		chances[69] = chances[68] = chances[67] = chances[66] = chances[65] = chances[64];

		chances[70] = new float[]{4, 4,     4, 5,      4, 4};
		chances[75] = chances[74] = chances[73] = chances[72] = chances[71] = chances[70];
