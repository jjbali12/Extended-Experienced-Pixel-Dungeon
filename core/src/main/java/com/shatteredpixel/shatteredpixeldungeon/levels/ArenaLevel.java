...
public class ArenaLevel extends Level {
	...
	protected boolean build() {
...

		{
			...
			// TODO OTHER BAGS
			for (int i = 0; i < 2; i++) itemsToSpawn.add(new PotionBag());
			for (int i = 0; i < 2; i++) itemsToSpawn.add(new ScrollBag());
			for (int i = 0; i < 2; i++) itemsToSpawn.add(new MiscBag());
