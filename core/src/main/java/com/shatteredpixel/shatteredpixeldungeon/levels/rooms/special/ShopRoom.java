...
public class ShopRoom extends SpecialRoom {
	...
	protected static ArrayList<Item> generateItems() {
			...
			itemsToSpawn.add(new GambleBag().quantity(Dungeon.Int(4, 1000)));
			itemsToSpawn.add(new QualityBag().quantity(Dungeon.Int(4, 1000)));
			itemsToSpawn.add(new AlchemyBag().quantity(Dungeon.Int(4, 1000)));
			itemsToSpawn.add(new BiggerGambleBag().quantity(Dungeon.Int(4, 1000)));
			itemsToSpawn.add(new ScrollBag().quantity(Dungeon.Int(4, 1000)));
			itemsToSpawn.add(new PotionBag().quantity(Dungeon.Int(4, 1000)));
			itemsToSpawn.add(new MiscBag().quantity(Dungeon.Int(4, 1000)));
			itemsToSpawn.add(new SpyGlass().quantity(Dungeon.Int(5, 1000)));
			itemsToSpawn.add(new RandomItemTicket().quantity(Dungeon.Int(5, 1000)));
			...
			itemsToSpawn.add( new SmallRation().quantity(Dungeon.Int(4, 1000)) );
			itemsToSpawn.add( new Cheese().quantity(Dungeon.Int(4, 1000)) );
	...
	protected static Bag ChooseBag(Belongings pack){
		...
		} else if (bestBag instanceof  TreasureHolder) {
