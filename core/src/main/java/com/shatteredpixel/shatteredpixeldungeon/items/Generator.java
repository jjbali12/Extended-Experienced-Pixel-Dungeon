...
public class Generator {
	...
	public enum Category {
		...
		WAND	( 1, 1, Wand.class ),
		RING	( 5, 5, Ring.class ),
		ARTIFACT( 5, 0, Artifact.class),
		
		FOOD	( 50, 50, Food.class ),
		
		POTION	( 50, 50, Potion.class ),
		SEED	( 50, 50, Plant.Seed.class ),
		
		SCROLL	( 50, 50, Scroll.class ),
		STONE   ( 50, 50, Runestone.class),
		TREASUREBAG(40, 50, TreasureBag.class),

		//EXSCROLL(50, 50, ExoticScroll.class),
		EXPOTION(50, 50, ExoticPotion.class),
		EXSCROLL(50, 50, ExoticScroll.class),
		
		GOLD	( 10, 50,   Gold.class );
		...
		static {
			...
			TREASUREBAG.classes = new Class<?>[]{
					...
					QualityBag.class,
					ScrollBag.class};
			TREASUREBAG.probs = new float[]{ 5, 5, 5, 5, 5, 5, 5 };
			...
			SCROLL.defaultProbs = new float[]{ 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10, 10 };
			...
			FOOD.classes = new Class<?>[]{
					...
					MysteryMeat.class,
					Cheese.class};
			FOOD.defaultProbs = new float[]{ 4, 1, 2, 10 };
