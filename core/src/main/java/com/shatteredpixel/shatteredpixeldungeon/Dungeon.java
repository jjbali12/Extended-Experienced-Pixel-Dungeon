...
public class Dungeon {
	...
	public static boolean isAscensionPossible(){
		return branch != BRANCH_ARENA && branch != BRANCH_BLACK && branch != BRANCH_CUSTOM;
	}
	...
	public static void init() {
		...
		luck = 50;
		energy = 0;
		if (Dungeon.isChallenged(OVERHAUL)) {
			respawn_timer = 5;
			additionalMobs = 40;
		} else {
			respawn_timer = 50;
    ...
    public static int escalatingDepth(int depth){
	    ...
	    switch (cycle){
			...
			case 5: return depth*150 + 7300;
			case 6: return depth*200 + 11300;
			case 7: return depth*250 + 20300;
			case 8: return depth*300 + 25300;
			case 9: return depth*500 + 100300;
			case 10: return depth*1000 * 100;
			case 11: default: return (((depth * 1000) * Dungeon.IntRange(350, 500)) * cycle);
			//default: return (int) ((depth * 1000) * Dungeon.IntRange(3, 10) * cycle);
		}
        //return depth;
    }
	...
	public static long seedForDepth(int depth, int branch){
		int lookAhead = depth;
		lookAhead += 105*branch; //Assumes depth is always 1-30, and branch is always 0 or higher
